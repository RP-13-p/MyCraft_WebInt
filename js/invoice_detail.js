document.addEventListener('DOMContentLoaded', () => {
    ...
    function renderPrintDocument() {
        const data = buildPrintData(invoice, 'invoice');
        ...
        printEl.innerHTML =
            ...
            '<div class="print-meta">' +
                ...
                '<div class="print-doc-info">' +
                    '<p class="print-doc-title">FACTURE N° ' + data.number + '</p>' +
                    '<p>Date : ' + fmtDate(data.date) + '</p>' +
                    '<p>Échéance : ' + fmtDate(data.due) + '</p>' +
            ...
            '<div class="print-legal">' +
                ...
                '<p>Paiement à réception de facture. En cas de retard, pénalités au taux légal en vigueur.</p>' +
            '</div>';
    }

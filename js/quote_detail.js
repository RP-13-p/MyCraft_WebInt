document.addEventListener('DOMContentLoaded', () => {
    ...
    function renderPrintDocument() {
        const data = buildPrintData(quote, 'quote');
        const printEl = document.getElementById('print-document');
        ...
        printEl.innerHTML =
            '<div class="print-header">' +
                '<div class="print-company-name">' + (data.company.name || 'MyCraft') + '</div>' +
            ...
            '<div class="print-meta">' +
                '<div class="print-client">' +
                    '<p><strong>Émis à</strong></p>' +
                    '<p>' + data.client + '</p>' +
                '</div>' +
                '<div class="print-doc-info">' +
                    '<p class="print-doc-title">DEVIS N° ' + data.number + '</p>' +
                    '<p>Date : ' + fmtDate(data.date) + '</p>' +
                    '<p>Validité : ' + (data.validity || '—') + ' jours</p>' +
                    (data.expiryDate ? '<p>Expire le : ' + fmtDate(data.expiryDate) + '</p>' : '') +
            ...
            '<div class="print-legal">' +
                ...
                '<p>Devis valable ' + (data.validity || '30') + ' jours à compter de la date d\'émission.</p>' +
            '</div>';
    }

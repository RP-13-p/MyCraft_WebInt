        ...
        invoices.forEach((inv, index) => {
            ...
            tr.innerHTML =
                ...
                '<td class="action-icons">' +
                    '<button type="button" class="print-invoice-btn action-icon-btn" aria-label="Imprimer" data-index="' + index + '">' +
                        ...
                        '</svg>' +
                    '</button>' +
                    '<button type="button" class="delete-invoice-btn action-icon-btn" aria-label="Supprimer" data-index="' + index + '">' +
                        '<svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="1.5">' +
